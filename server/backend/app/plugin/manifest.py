...
class ConfigFieldSpec(BaseModel):
    ...
    `type` is one of "str" | "int" | "bool" | "list_str" | "dict_str_str" —
    the small set actually needed by the current integration config keys.
    """

    type: Literal["str", "int", "bool", "list_str", "dict_str_str"] = "str"
    required: bool = False
    secret: bool = False
    default: Any = None
    description: str = ""
