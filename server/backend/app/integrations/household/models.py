...
# ---------------------------------------------------------------------------
#
# Four keywords join the shipped `snag`: `task`, `nag`, `discuss`, `surface`.
# A message like "nag Tupperware drawer" is captured and attributed to
# whoever sent it. Structurally this borrows `snags`' capture shape (windowed
