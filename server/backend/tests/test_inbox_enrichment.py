...
class TestListPendingFields:
    ...
    def transcriber(self, monkeypatch):
        ...
        class _Notify:
            ...
            def send(self, title, body, severity="warning", user_id=None):
...
class TestDescribePendingAnnounces:
    ...
    def test_a_failed_description_is_not_announced(self, inbox, vision):
        """Better silent than a push saying 'image' and nothing else."""
        self._image(inbox)
