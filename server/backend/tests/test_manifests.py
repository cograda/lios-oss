...
Covers:
  - The real tree: discover_manifests() finds all 29 integration manifests
...
class TestRealTree:
    def test_discover_manifests_finds_all_29_integrations(self):
    ...
    def test_duplicate_tool_name_raises(self, real_integrations):
        class _FakeIntegration:
            ...
            def mcp_tools(self):
                ...
                any_real_name = next(iter(real_integrations.values())).mcp_tools()[0]["name"]
