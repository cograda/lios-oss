...
ALLOWLIST: dict[tuple[str, int], str] = {
    ...
    (
        # Line number shifted 373 -> 349 (Wave 5.10, 2026-09-05): the dead
        # `GET /{name}/history` route above this one was deleted (no caller
        # in frontend/client/loops, no test — see
        # tests/test_route_reachability.py), 29 lines removed.
        "app/routes/integrations.py", 360,
    ): (
