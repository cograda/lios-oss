<!-- GENERATED from server/backend/app/prompts/templates/find.md.j2 via app.prompts.commands — do not hand-edit. Edit the template and run scripts/render_commands.py (or refetch GET /api/v1/commands). -->
